...
<%-- INIZIO HOOK --%>
<%@ include file="/html/portlet/asset_publisher/init.tref-multi-categories-tags-portlet.jsp" %>
<%-- FINE HOOK --%>
	...
	<liferay-ui:section>
		...
		<liferay-ui:panel-container extended="<%= true %>" id="assetPublisherDynamicSelectionAssetSelectionPanelContainer" persistState="<%= true %>">
			...
			<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" 
				id="assetPublisherMultipleCategoriesPanelContainer" persistState="<%= true %>" 
				title="label-multi-categories-tags-categories">
				
				<aui:input label="label-multi-categories-tags-categories-search-or"
					name="preferences--useOrOperatorCategorySearch--" 
					type="checkbox" checked="<%=useOrOperatorCategorySearch %>" />
			
			</liferay-ui:panel>
			
			<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" 
				id="assetPublisherMultipleTagsPanelContainer" persistState="<%= true %>" 
				title="label-multi-categories-tags-tags">
				
				<aui:input label="label-multi-categories-tags-tags-search-or"
					name="preferences--useOrOperatorTagSearch--" 
					type="checkbox" checked="<%=useOrOperatorTagSearch %>" />
